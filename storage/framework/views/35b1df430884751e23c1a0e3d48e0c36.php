...
<head>
    ...
    <style>
        ...
        .pomodoro {
    background-image: url('<?php echo e(asset('timerbg.png')); ?>'); /* Set the background image */
...
.icon {
    ...
    color: white; /* Default icon color */
        ...
        .todo-list {
    background-image: url('<?php echo e(asset('notebook.jpg')); ?>'); /* Set the background image */
    background-size: cover; /* Cover the entire area */
    background-position: center; /* Center the image */
    padding: 20px;
    border-radius: 5px;
...
<body>
<div class="header">
    <img src="<?php echo e(asset('logo learnaid.png')); ?>" alt="Learnaid Logo">
    <div class="auth-links">
        <?php if(Auth::check()): ?>
            <span style="margin-right: 10px;">Welcome <?php echo e(Auth::user()->name); ?>, let's study!</span> <!-- Display the user's name -->
            <img src="<?php echo e(asset('acc-logo.jpg')); ?>" alt="Profile Icon" class="profile-icon"> <!-- Profile icon -->
            <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?> <!-- Ensure this is correct -->
            </form>
        <?php else: ?>
...
<div class="main-section">
    ...
    <div class="todo-list">
        ...
        <form action="<?php echo e(route('tasks.store')); ?>" method="POST" style="display: flex; align-items: center;">
            <?php echo csrf_field(); ?>
        ...
        <ul>
            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <form action="<?php echo e(route('tasks.update', $task)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="text" name="title" value="<?php echo e($task->title); ?>" required style="margin-right: 10px;">
                        <button type="submit" class="icon-button">
...
<div class="scrollable-content">
    <div class="info-section">
        <div class="image-section">
            <img class="tomato-image" src="<?php echo e(asset('aboutgif.gif')); ?>" alt="LearnAid GIF" />
        </div>
...
<footer class="footer text-center" style="background-color: #f8f9fa; padding: 20px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-3 text-center">
            <img src="<?php echo e(asset('ferry.png')); ?>" alt="Ferry Jaya Dinata" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        ...
        <div class="col-md-3 text-center">
            <img src="<?php echo e(asset('reinaldy.png')); ?>" alt="Reinaldy Zulfananda Arkaan" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        ...
        <div class="col-md-3 text-center">
            <img src="<?php echo e(asset('sean.png')); ?>" alt="Sean Kenneth Tommy Keleyan" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        ...
        <div class="col-md-3 text-center">
            <img src="<?php echo e(asset('syafiq.png')); ?>" alt="Syafiq Ammaar Muhadzdzib" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
...
</html><?php /**PATH C:\xampp\htdocs\learnaid1\resources\views/welcome.blade.php ENDPATH**/ ?>